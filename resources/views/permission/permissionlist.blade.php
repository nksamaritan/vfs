...
@section('pageTitle')
    {{__('app.default_list_title',["app_name" => __('app.app_name'),"module"=> __('app.permission')])}}
@endsection
                                        ...
                                        @if(count($permissionData) > 0)
                                            @foreach($permissionData as $row)
                                                <tr>
                                                    ...
                                                    <td>{{$row->code}}</td>
                                                    <td>
                                                        <div class="icon pull-left"><a href="{{$baseUrl.'/permission/edit/'.$row->id}}"><span title="Edit" class="mdi mdi-edit"></span></a></div>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @else
